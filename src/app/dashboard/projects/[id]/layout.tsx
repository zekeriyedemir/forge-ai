...
export default async function ProjectLayout({ children, params }: { children: React.ReactNode; params: Promise<{ id: string }> }) {
  ...
  const tabs = [{ slug: "", label: "Overview" }, { slug: "/agents", label: "Agents" }, { slug: "/tasks", label: "Tasks" }, { slug: "/reports", label: "Reports" }, { slug: "/metrics", label: "Metrics" }, { slug: "/activity", label: "Activity" }, ...(canDelete ? [{ slug: "/settings", label: "Settings" }] : [])];
